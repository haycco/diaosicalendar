/**
 * Usage: 获取农历日 getLunarCalendar().lunarDate
 *        获取星期 getLunarCalendar().week
 *        获取阳历年月日格式 getLunarCalendar().fullYear
 * @author haycco
 * @version 1.0.0
 */
var getLunarCalendar = function(dateObj){
  ...
  this.getWeeks = function(){
    ...
    return "星期" + day[this.dateObj.getDay()];
  };
  //获取年月日
  ...
  return {  fullYear: this.getFullYear(), 
            week: this.getWeeks(), 
